...
#define FFMPEG_CONFIGURATION "--prefix=./build --toolchain=msvc --disable-everything --disable-network --disable-autodetect --disable-doc --disable-static --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-stripping --enable-gpl --enable-shared --enable-small --enable-decoder='h264,hevc,aac,flac' --enable-hwaccel='h264_dxva2,hevc_dxva2' --enable-demuxer='mov,m4v,matroska,flac,flv' --enable-protocol=file --enable-dxva2 --enable-swresample --enable-swscale"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "./build/share/ffmpeg"
#define AVCONV_DATADIR "./build/share/ffmpeg"
#define CC_IDENT "用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.27.29112 版"
